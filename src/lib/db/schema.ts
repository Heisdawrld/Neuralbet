...
export async function ensureSchema() {
  ...
  await cx.batch([
    ...
    `CREATE INDEX IF NOT EXISTS idx_pr_user ON prediction_records(clerk_user_id)`,
    `CREATE INDEX IF NOT EXISTS idx_pr_fixture ON prediction_records(fixture_id)`,
    `CREATE INDEX IF NOT EXISTS idx_pr_status ON prediction_records(status)`,
